...
CREATE TABLE "ShopConfig" (
    ...
    "name" TEXT NOT NULL DEFAULT 'RR Kitchen',
    "lat" DOUBLE PRECISION NOT NULL,
    "lng" DOUBLE PRECISION NOT NULL,
...
CREATE TABLE "DeliveryFeeSlab" (
    "id" TEXT NOT NULL,
    "shopConfigId" TEXT NOT NULL DEFAULT 'shop_config',
...
-- CreateIndex
CREATE INDEX "DeliveryFeeSlab_shopConfigId_idx" ON "DeliveryFeeSlab"("shopConfigId");
...
-- AddForeignKey
ALTER TABLE "DeliveryFeeSlab" ADD CONSTRAINT "DeliveryFeeSlab_shopConfigId_fkey" FOREIGN KEY ("shopConfigId") REFERENCES "ShopConfig"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
